...
export default function CTASection() {
    return (
        <section className="w-full my-10 md:my-20 max-w-sm md:max-w-325 bg-[#091E3E] mx-auto py-20 px-[4%] rounded-3xl flex items-center justify-center flex-col text-center text-white gap-5 font-plus-jakarta  "  >
